...
<section class="small-banner case-study">
	<div class="container">
		<div class="bannerr-text">
			...
			<h2 data-aos="zoom-in" data-aos-duration="1500">{{$caseStudies->title}}</h2>
      <p data-aos="zoom-in" data-aos-duration="1500">{{$caseStudies->description}}</p>
		</div>
	</div>
</section>

<section class="blog-inner-content case-single">
	<div class="container">
		<div class="blog-inner-text">
			...
			<div class="row">
				<div class="col-md-12" data-aos="fade-up" data-aos-duration="500">
					<?php print $caseStudies->long_description; ?>
			
					<!-- <img src="{{$caseStudies->image_url}}" data-aos="zoom-in" data-aos-duration="500"> -->
				</div>
			</div>
		</div>
