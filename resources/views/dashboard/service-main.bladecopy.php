	...
	<div class="container">
		...
		<div class="service-tabs-content">
			<div class="service-tabs-buttons">
					...
					@foreach ($services as $service)
					  <li class="nav-item service-card" role="presentation">
					    <button class="nav-link " id="pills-home-tab{{$service->id}}" data-bs-toggle="pill" data-bs-target="#pills-home{{$service->id}}" type="button" role="tab" aria-controls="pills-home" aria-selected="true">
					    		<img width="50px" height="50px" src="{{$service->image_url}}">
								<h4 class="green" data-aos="fade-up" data-aos-duration="500">{{$service->title}}</h4>
					    </button>
					  </li>
					  @endforeach
					  ...
					  {{-- <li class="nav-item service-card" role="presentation">
					    <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">
								...
								<h4 class="green" data-aos="fade-up" data-aos-duration="500">Professional Services for IGA,<br>IAM & PAM</h4>
					    </button>
					  </li> --}}
					</ul>
				</div>
			<div class="tab-content" id="pills-tabContent">
				@foreach ($services as $service)
			  <div class="tab-pane fade " id="pills-home{{$service->id}}" role="tabpanel" aria-labelledby="pills-home-tab{{$service->id}}">
			  	<div class="service-card">
					<?php print $service->description;?>
					...
					<a href="{{route('service-page',$service->slug)}}">Learn  More</a>
				</div>
			  </div>
			  @endforeach
			  ...
			  {{-- <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
				...
				<a href="service-page-2.php">Learn  More</a>
			  	</div>
			  </div> --}}
			</div>
		</div>
