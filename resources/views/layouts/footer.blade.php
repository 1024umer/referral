	...
	<div class="container">
		<div class="footer-content">
			<div class="row">
				...
				<div class="col-md-4">
					<div class="footer-sec secnod">
						<h5>Contact</h5>
						<ul>
							<li><a href="tel:+1-312-731-5750">(312) 731-5750</li>
							<li class="bdr non"><a href="javascripts:void(0)">Chicago, IL 60642-6421</a></li>
							<li><a href="www.aohwv.com">www.aohwv.com</a></li>
							<li class="bdr"><a href="mailto:lhees@aohwv.com">lhees@aohwv.com</a></li>
						</ul>
					</div>
				</div>
				...
				<div class="col-md-4">
					...
					<div class="social-icons">
					  <ul>
						<li><a href="https://www.instagram.com/aoh_iam/" target="_blank"><i class="fa-brands fa-instagram"></i></a></li>
						<li><a href="https://twitter.com/AOHWV" target="_blank"><i class="fa-brands fa-twitter"></i></a></li>
						<li><a href="https://www.linkedin.com/company/atomic-orbital-hydrogen-wave-vector" target="_blank"><i class="fa-brands fa-linkedin-in"></i></a></li>
						<li><a href="https://defcon.social/@LauraHees" target="_blank"><i class="fa-brands fa-mastodon"></i></a></li>
					  </ul>
					</div>
				</div>
...
<hr>
	<div class="container">
		<div class="copy-right">
			<p>2023 aohwv © All rights reserved</p>
		</div>
	</div>
