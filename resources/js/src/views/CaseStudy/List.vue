<template>
    <v-row>
        ...
        <v-col cols="1">
            <v-btn color="success" link :to="{ name: 'auth.cases.add' }">Add Case Studies</v-btn>
        </v-col>
        <v-col cols="12">
            <v-row>
                <v-col>
            ...
            <v-data-table-server v-model:items-per-page="itemsPerPage" :headers="headers" :items-length="totalItems"
                ...
                <template v-slot:item.is_featured="{ item }">
                    <div
                        :class="{ 'green-background': item.selectable.is_featured === 1, 'red-background': item.selectable.is_featured !== 1 }">
                ...
                <template v-slot:item.actions="{ item }">
                    <v-btn link :to="{ name: 'auth.cases.edit', params: { id: item.selectable.id } }" color="info"
