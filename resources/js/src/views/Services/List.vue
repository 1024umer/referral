<template>
    <v-row>
        ...
        <v-col cols="1">
            <v-btn  color="success" link :to="{ name: 'auth.services.add' }">Add Services</v-btn>
        </v-col>
        <v-col cols="12">
            <v-row>
                <v-col>
            ...
            <v-data-table-server v-model:items-per-page="itemsPerPage" :headers="headers" :items-length="totalItems"
                ...
                @update:options="loadItems">
                    ...
                    <template v-slot:item.actions="{ item }">
                        <v-btn link :to="{ name: 'auth.services.edit', params: { id: item.selectable.id } }" color="info" density="comfortable" size="small"
